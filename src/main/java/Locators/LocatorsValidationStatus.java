...
public class LocatorsValidationStatus {
    ...
    public static final By INPUT_TITULO_ENTREVISTA = By.xpath("//div[label[text()='Título de la Entrevista']]/following-sibling::div/input");
    ...
    public static final By INPUT_FECHA = By.xpath("//div[label[text()='Fecha']]/following-sibling::div/div//input");
    public static final By INPUT_TIEMPO = By.xpath("//div[label[text()='Tiempo']]/following-sibling::div/div//input");
